...
const ProviderFactory = require('./src/network-providers/providers-factory');
...
module.exports = (function () {
    ...
    const init = function (network = 'local') {
        ...
        const provider = providerFactory.create(network);
    ...
    return {
        init: init,
        utils: utils,
        NETWORKS: ProviderFactory.availableNetworks().all
    };
})();
