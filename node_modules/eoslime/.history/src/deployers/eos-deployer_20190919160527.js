        ...
        defineImmutableProperties(this, [
            {
                ...
                value: async function (wasmPath, abiPath, contractAccount, options = defaultDeployOptions) {
                    ...
                    const a = await provider.eos.setcode(contractAccount.name, 0, 0, wasm, { keyProvider: contractAccount.privateKey });
                    const b = await provider.eos.setabi(contractAccount.name, abi, { keyProvider: contractAccount.privateKey });
                    console.log(a)
                    console.log(b)
