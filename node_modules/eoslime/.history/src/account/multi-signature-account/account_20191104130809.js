...
class MultiSignatureAccount extends Account {
    ...
    async buyRam(bytes, payer = this) {
        ...
        const systemContract = await contractFactory.at('eosio', payer);
    ...
    async send(receiver, amount, symbol = 'EOS') {
        ...
        const contractFactory = new ContractFactory(this.provider);
        const tokenContract = await contractFactory.at('eosio.token', payer);
...
const requireContractAction = function (contractAction) {
    if (!contractAction) {
