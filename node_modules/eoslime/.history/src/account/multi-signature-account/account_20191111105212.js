...
class MultiSignatureAccount extends Account {
    ...
    async approve(approver, proposalId) {
        ...
        //     throw new Error('Proposer has already signed the transaction');
        // } else {
    ...
    async processProposal(proposalId) {
        ...
        console.log(proposalTx.transaction.actions)
        console.log(proposalTx.transaction.actions[0].authorization)
        return this.provider.eos.pushTransaction(proposalTx.transaction, {});
    }
}
