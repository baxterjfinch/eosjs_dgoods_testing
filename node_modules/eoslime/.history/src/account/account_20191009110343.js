...
class Account {
    ...
    async setThreshold(threshold) {
        ...
        console.log(authorityInfo.required_auth);

        return setAuthority.call(this, authorityInfo.perm_name, authorityInfo.parent, authorityInfo.required_auth.threshold);
    }
