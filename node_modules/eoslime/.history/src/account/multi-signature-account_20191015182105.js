...
class MultiSignatureAccount extends BaseAccount {
    ...
    async execProposal(proposalName, executor = this) {
...
const executeMultiSignatureAction = async function (actionName, actionParams) {
    return this.provider.eos.transaction({
        actions: [{
            ...
            name: actionName,
            authorization: [{
                actor: this.accounts[0].executiveAuthority.actor,
                permission: this.accounts[0].executiveAuthority.permission,
            }],
            data: actionParams,
        }]
    }, { broadcast: true, sign: true, keyProvider: this.accounts[0].privateKey });
}
