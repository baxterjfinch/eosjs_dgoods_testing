...
class MultiSignatureAccount extends Account {
    ...
    async buyBandwidth(cpu, net, payer = this) {
        ...
        // const abiInterface = (await this.provider.eos.getAbi('system')).abi;
        // const systemContract = new Contract(this.provider, abiInterface, contractName, payer);
...
const retrieveSystemContract = async function (executor) {
    ...
    const systemContract = new Contract(this.provider, abiInterface, 'eosio', executor);
    return systemContract;
    if (!systemContract.buyram) {
