...
class AccountFactory {
    ...
    async loadMultisig(name, privateKey, authorityName = DEFAULT_AUTHORITY) {
        try {
            const multiSignatureAccount = await this.provider.eos.getAccount(this.name);
            ...
            return new MultiSignatureAccount(name, privateKey, this.provider, authorityName, multiSignatureAccount);
        } catch (error) {
            console.log(error)
            throw new Error('Invalid private key. Invalid checksum');
        }
