...
class MultiSignatureAccount extends BaseAccount {
    ...
    async approveKey(approver, contractName, actionName) {
        ...
        const actionTx = await contractInstance[action].getSignedTransaction(approver, ...actionData);
    ...
    async execKey(contractName, actionName, executor = this) {
        ...
        const contract = this.contracts[contractName][actionName];
        executeMultiSignatureAction()
