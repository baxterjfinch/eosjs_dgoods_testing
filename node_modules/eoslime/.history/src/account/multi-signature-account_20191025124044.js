...
class MultiSignatureAccount extends Account {
    ...
    async buyRam(bytes, payer = this) {
        ...
        const systemContract = await retrieveontract.call(this, 'eosio', payer);
        validateContractAction(systemContract, 'buyrambytes');
    ...
    async buyBandwidth(cpu, net, payer = this) {
        ...
        const systemContract = await retrieveSystemContract.call(this, 'eosio', payer);
...
const validateContractAction = async function (systemContract, action) {
