...
class MultiSignatureAccount extends Account {
    ...
    async approve(approver, proposalId) {
        ...
        if (approver.name == this.name) {
            const actionTx = await proposalAction.action.signTransaction(this, approver, ...proposalAction.data);
        } else {
            const actionTx = await proposalAction.action.signTransactionOnBehalf(this, approver, ...proposalAction.data);
        }
