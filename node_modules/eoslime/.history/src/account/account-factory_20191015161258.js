...
class AccountFactory {
    ...
    async loadMultisig(name, privateKey, accounts, authorityName = DEFAULT_AUTHORITY) {
        try {
            const accountInfo = await this.provider.eos.getAccount(name);
            ...
            return new MultiSignatureAccount(name, privateKey, this.provider, authorityName, accountInfo);
        } catch (error) {
            console.log(error)
            throw new Error('Invalid private key. Invalid checksum');
        }
