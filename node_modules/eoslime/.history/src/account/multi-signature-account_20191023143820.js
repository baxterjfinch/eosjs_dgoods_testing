...
class MultiSignatureAccount extends BaseAccount {
    ...
    async proposeKey(contractName, action, ...actionData) {
        ...
        this.contracts[contractName] = { abi: contractInstance, params: actionData };
    ...
    async execProposal(contractName, actionName, executor = this) {
        is(executor).instanceOf(BaseAccount);

        await contractInstance[action]()
    }

    async execKey(msig, contractName, executor = this) {
        is(executor).instanceOf(BaseAccount);
