...
class MultiSignatureAccount extends BaseAccount {
    ...
    async approveKey(approver, contractName, actionName) {
        ...
        console.log(approver.publicKey)
    ...
    async execKey(contractName, actionName) {
        ...
        proposalTx.transaction.signatures = proposalTx.signatures
        return pushMultiSignatureTransaction.call(this, proposalTx.transaction)
