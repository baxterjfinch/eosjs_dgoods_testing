...
const AuthorityAccount = require('../authrotiy-account/account');
...
class Account extends BaseAccount {
    ...
    async createAuthority(authorityName, threshold = 1) {
        ...
        return new AuthorityAccount(this.name, this.privateKey, this.provider, authorityName, this.executiveAuthority.permission);
    }
