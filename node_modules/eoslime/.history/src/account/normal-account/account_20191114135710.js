...
const AuthorityAccountFactory = require('../authrotiy-account/authority-account-factory');
...
class Account extends BaseAccount {
    ...
    async createAuthority(authorityName, threshold = 1) {
        ...
        return AuthorityAccountFactory.create(this.name, this.privateKey, this.provider, authorityName, this.executiveAuthority.permission);
    }
