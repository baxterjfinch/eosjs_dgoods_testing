...
class Account {
    ...
    async createAuthority(authorityName, threshold = 1) {
        ...
        // await linkAuthority.call(this, authorityName,
        //     [
        //         {
        //             action: 'linkauth',
        //             contract: 'eosio'
    ...
    async setAuthorityAbilities(abilities) {
        await linkAuthority.call(this, this.executiveAuthority.permission, abilities);
    }
    ...
    async getAuthorityInfo() {
        return getAuthorityData.call(this, this.executiveAuthority.permission);
    }
...
const linkAuthority = async function (authorityName, abilities) {
    is(abilities).instanceOf(Array);
    await getAuthorityData.call(this, authorityName);

    console.log((await this.provider.eos.transaction(tr => {
    ...
    }, { broadcast: true, sign: true, keyProvider: this.privateKey })).transaction.transaction.actions);
}

const getAuthorityData = async function (authorityName) {
