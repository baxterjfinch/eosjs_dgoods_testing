...
class MultiSignatureAccount extends BaseAccount {
    ...
    approveProposal(approver, proposalName) {
        ...
        await msigContract.approve(this.name, proposalName, approver.executiveAuthority.permission, actionTx)
    }
    ...
    async propose(contractName, action, ...actionData) {
        ...
        const msigContract = getLazyMSigContractInstance();
        await msigContract.propose('testajungle2', 'jungle.' + randomName, [accountInfo.required_auth], actionTx)
