...
class MultiSignatureAccount extends BaseAccount {
    ...
    async approveProposal(msig, approver, proposalName) {
        ...
        await msig.approve(approver.name, proposalName, approver.executiveAuthority, { from: approver })
    ...
    async execProposal(proposalName, executor = this) {
        ...
        await msig.exec(executor.name, proposalName, executor.name, { from: executor })
