...
class ContractFunction extends EventClass {
    constructor(contract, functionName, contractStructs) {
        ...
        const contractFunction = async function (...params) {
            const functionTx = await buildFunctionTx(...params);
        ...
        contractFunction.getRowTransaction = async function (...params) {
            const functionTx = await buildFunctionTx(...params);
            const rowTransaction = await executeFunction(contract.provider.eos, functionTx);
...
const buildFunctionTx = async function (...params) {
