...
module.exports = {
    ...
    getRawTransaction: async function (contract, action, ...actionParams) {
        const actionTx = await contract[action](...actionParams, { broadcast: false, sign: false })
        return actionTx.transaction.transaction
    }
}
