    ...
    process(optionValue, args) {
        if (optionValue != 'false') {
            ...
            args.testFramework.on('allFinished', () => {
                ...
                for (let i = 0; i < contractsResources.length; i++) {
                    const contractResources = contractsResources[i];
                    for (let j = 0; j < contractResources.functions.length; j++) {
                        const functionResources = contractResources.functions[j];


                    }
                    actionResources.push([
