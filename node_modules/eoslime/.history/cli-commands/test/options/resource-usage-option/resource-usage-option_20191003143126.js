...
const filterByMaxAndMinResources = function (contractsUsage) {
    for (let i = 0; i < contractsUsage.length; i++) {
        const contractUsage = functionsResources[i];
        for (let j = 0; j < contractUsage.functionsResources.length; j++) {
            const functionResources = contractUsage.functionsResources[i];
            const minResources = Math.min(...functionResources);
            const maxResources = Math.max(...functionResources);
