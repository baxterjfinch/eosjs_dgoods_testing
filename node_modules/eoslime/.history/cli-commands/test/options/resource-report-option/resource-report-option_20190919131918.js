    ...
    process(optionValue, args) {
        if (optionValue != 'false') {
            ...
            args.eoslime.Contract.on('init', (contract) => {
                addResourceUsageOfEachFunctionToReport(contract, contractsFunctionsResources);
            });
            args.eoslime.Contract.on('deploy', (contract) => {
                addResourceUsageOfEachFunctionToReport(contract, contractsDeploymentsResources);
            });
...
const addResourceUsageOfEachFunctionToReport = function (contract, reportTable) {
