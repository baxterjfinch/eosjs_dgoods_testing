...
class ResourceReportOption extends Option {
    ...
    // Todo: Implement addSection in report table

    process(optionValue, args) {
        if (optionValue != 'false') {
            optionValue = optionValue || 'local';

            const contractsFunctionsResources = [];
            // const contractsDeploymentsResources = [];

            args.eoslime.Contract.on('init', (contract) => {
                extractResourcesUsageForEachContractMethod(contract, contractsFunctionsResources);
            });
            ...
            args.testFramework.on('allFinished', () => {
                this.reportTable.addSection(
                    'Contract functions resources',
                    contractsFunctionsResources
                );
...
const extractResourcesUsageForEachContractMethod = function (contract, contractsFunctionsResources) {
