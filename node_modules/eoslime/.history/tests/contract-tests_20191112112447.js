    ...
    */
    ...
    describe("Blockchain methods", function () {
        ...
        it('Should get the raw transaction from the action', async () => {
            ...
            const rawTx = await faucetContract.produce.getRawTransaction(tokensHolder.name, '100.0000 TKNS', tokenContract.name, 'memo');
            console.log(rawTx);
        });
        ...
        it('Should sign the action without broadcasting it', async () => {
            ...
            await faucetContract.produce.getRawTransaction(tokensHolder.name, '100.0000 TKNS', tokenContract.name, 'memo');
        });
