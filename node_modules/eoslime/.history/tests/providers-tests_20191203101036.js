...
describe('Providers', function () {
    ...
    describe('Retrieve table', function () {
        ...
        it.only('Should retrieve table', async () => {
            // const eoslimeInstance = eoslime.init();
            ...
            const balanceWithdrawers1 = await Provider.select('withdrawers').from(faucetContract.name).scope(tokenContract.name).equal(100 * TOKEN_PRECISION).index(2).find();
            console.log(balanceWithdrawers1)
        });
    });
});
