...
const MultiSignatureAccountStub = require('./stubs/multi-signature-account-stub');
...
describe('Multi signature account', function () {
   ...
   */
    async function deployEOSIO() {
        await eoslime.Contract.deploy(EOSIO_SYSTEM_WASM_PATH, EOSIO_SYSTEM_ABI_PATH);
    }
