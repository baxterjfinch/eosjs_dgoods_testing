    ...
    describe('Instantiation', function () {
        ...
        describe('Set authority abilities', function () {
            xit('Should set authority abilities and execute a granted action', async () => {
                ...
                await accountRandomAuth.addAuthorityKey(keys[0].publicKey)
                await accountRandomAuth.addAuthorityKey(keys[1].publicKey)
                await accountRandomAuth.setThreshold(2);
