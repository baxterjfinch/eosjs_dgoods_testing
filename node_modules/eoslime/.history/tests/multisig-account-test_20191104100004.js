...
describe('Multi signature account', function () {
   ...
   */
    ...
    describe.only('Buy ram', function () {
        ...
        require('./../src/account/multi-signature-account')
        let MultisignatureAccount = proxyquire('./../src/account/multi-signature-account', { './../contract/contract-factory': ContractFactoryStub })
        beforeEach(async () => {
