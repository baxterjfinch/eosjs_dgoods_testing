    ...
    describe('Process proposal', function () {
        ...
        it('Should throw if the proposal is over approved', async () => {
            try {
                ...
                assert(error.includes('Proposal should be approved 1 times, but it is approved 2 times'));
            }
        });
        ...
        it('Should throw if the proposal is under approved', async () => {
            try {
                ...
                assert(error.includes('Proposal should be approved 1 times, but it is approved 0 times'));
            }
        });
    });
