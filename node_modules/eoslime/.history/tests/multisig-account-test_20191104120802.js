...
describe('Multi signature account', function () {
    ...
    describe.only('Buy ram', function () {
        ...
        */
        ...
        beforeEach(async () => {
            ContractFactoryStub.setContractName(eosioSystemContract.name);
            MultiSignatureAccount = proxyquire('./../src/account/multi-signature-account', { './../contract/contract-factory': ContractFactoryStub })
        });

        it.only('Should buy ram [payer]', async () => {
        ...
        it.only('Should buy ram by self', async () => {
            ...
            const buyRamProposal = await multiSigAccount.buyRam(1000, payer);
    ...
    describe('Multi signature transaction', function () {
        it('Should be signed by multiple accounts and be processed', async () => {
            ...
            eoslime.MultiSignatureAccount.load(account.name, account.privateKey);
