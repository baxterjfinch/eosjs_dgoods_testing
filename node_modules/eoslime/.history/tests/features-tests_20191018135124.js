...
describe.only('Features', function () {
    ...
    describe.only('Set authority abilities', function () {
        it('Should execute an action from custom authority', async () => {
            ...
            const proposalData = await multiSigAccount.propose(mutisigContract, faucetAccount.name, 'produce', account.name, "100.0000 TKNS", faucetaccountAaccountccount.name, "memo")
