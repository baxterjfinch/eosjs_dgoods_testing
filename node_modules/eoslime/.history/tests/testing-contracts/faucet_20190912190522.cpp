...
public:
  ...
  typedef eosio::multi_index<"items"_n, item,
                             eosio::indexed_by<"byextid"_n, eosio::const_mem_fun<item, uint64_t, &item::by_external_id>>,
                             eosio::indexed_by<"bystate"_n, eosio::const_mem_fun<item, uint64_t, &item::by_state>>>
      items;
  items items_table;
