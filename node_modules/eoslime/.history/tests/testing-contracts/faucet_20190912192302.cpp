...
public:
	...
	TABLE withdrawer
	{
		...
		asset balance_key() const { return quantity.symbol.code().raw(); }
	};
	typedef eosio::multi_index<"withdrawers"_n, withdrawer, eosio::indexed_by<"bybalance"_n, eosio::const_mem_fun<withdrawer, asset, &withdrawer::balance_key>>> withdrawers;
