...
public:
	...
	TABLE withdrawer
	{
		...
		int64_t balance_key() const { return quantity.amount; }
	};
	typedef eosio::multi_index<"withdrawers"_n, withdrawer, eosio::indexed_by<"bybalance"_n, eosio::const_mem_fun<withdrawer, int64_t, &withdrawer::balance_key>>> withdrawers;
