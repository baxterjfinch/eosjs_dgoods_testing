...
public:
	...
	TABLE withdrawer
	{
		...
		uint64_t secondary_key() const { return quantity.amount; }
	};
	typedef eosio::multi_index<"withdrawers"_n, withdrawer, eosio::indexed_by<"bybalance"_n, eosio::const_mem_fun<withdrawer, uint64_t, &withdrawer::secondary_key>>> withdrawers;
