...
public:
	...
	typedef eosio::multi_index<"withdrawers"_n, withdrawer, eosio::indexed_by<"bybalance"_n, eosio::const_mem_fun<withdrawer, int64_t, &withdrawer::secondary_key>>> withdrawers;
