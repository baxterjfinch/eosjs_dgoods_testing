...
describe('Account', function () {
    ...
    */
    ...
    describe('Instantiation', function () {
        ...
        describe.only('Set threshold', function () {
            ...
            it('Should decrease authority threshold', async () => {
                ...
                await account.increaseThreshold(INCREASED_THRESHOLD);

                authorityInfo = await account.getAuthorityInfo();
                assert(authorityInfo.required_auth.threshold == INCREASED_THRESHOLD);

                console.log(eoslimeTool.Provider.eos)
                await account.increaseThreshold(DECREASED_THRESHOLD);
                // await keysPairAccount.increaseThreshold(DECREASED_THRESHOLD);
