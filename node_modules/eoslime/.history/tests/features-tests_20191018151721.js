...
describe.only('Features', function () {
    ...
    describe.only('Set authority abilities', function () {
        ...
        it.only('Should execute an action from custom authority', async () => {
            ...
            await multiSigAuth.setAuthorityAbilities([
                {
                    action: 'propose',
                    contract: mutisigContract.name
                },
                {
                    action: 'approve',
                    contract: mutisigContract.name
            ...
            // const proposalData = await multiSigAccount.proposeKey(mutisigContract, faucetAccount.name, 'produce', firstKeyAcc.name, "100.0000 TKNS", firstKeyAcc.name, "memo")
